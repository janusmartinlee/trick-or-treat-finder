...
void main() {
  group('Feature: User preferences management', () {
    ...
    group('Scenario: User changes theme preference', () {
      test('Given default preferences, When user changes to dark theme, Then preferences are updated', () async {
      ...
      test('Given dark theme selected, When user changes to light theme, Then preferences are updated', () async {
    ...
    group('Scenario: User changes language preference', () {
      test('Given default locale, When user changes to Spanish, Then preferences are updated', () async {
    ...
    group('Scenario: Preferences persistence', () {
      test('Given preferences are set, When retrieving preferences, Then correct values are returned', () async {
    ...
    group('Scenario: Preferences change notification', () {
      test('Given listening to preferences stream, When preferences change, Then stream emits new values', () async {
